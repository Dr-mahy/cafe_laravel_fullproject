            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="{{route('insertbeverage')}}">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="special" {{old('special')? "checked" : ""}} class="flat">
                                    </label>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="file" id="image" name="img" required="required" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control" name="category_id" id="">
                                        ...
                                        <option value="{{$category->id}}"{{ old('category') == '' ? 'selected' : '' }}>{{$category->category}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
